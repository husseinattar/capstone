...
contract Ownable {
    ...
    event ownerShipTransfered(address newOnwer) ; 

    //  4) fill out the transferOwnership function
    function transferOwnership(address newOwner) public onlyOwner {
        // TODO add functionality to transfer control of the contract to a newOwner.
        // make sure the new owner is a real address
        require(address(newOwner) != address(0) , "New Owner is not a real address");
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require( owner != to , "Not allowed to be the owner");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require( owner == msg.sender || isApprovedForAll(owner, msg.sender), "Caller is not the owner OR doesnot have approval all status" );
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require( !_exists(tokenId) || address(to) != address(0) , "Token doesnot exist OR address is invalid");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        //CHECK if need to erase _operatorApprovals
...
//CHECK
contract NeomXERC721Token is ERC721Metadata ("Real Estate Marketplace", "NeomXToken", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/" )
{
...
*/
    ...
    event mintNeomX(string tokenURI);
